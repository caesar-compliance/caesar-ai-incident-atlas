...
All notable changes to the Caesar AI Incident Atlas project will be documented in this file.
...
- **System Specifications:** Created [SPEC.md](SPEC.md) detailing inputs, outputs, non-goals, and database boundaries.
- **Architectural Scaffolding:** Added [ARCHITECTURE.md](ARCHITECTURE.md) outlining threat parser layers and mitigation mapping pipelines.
